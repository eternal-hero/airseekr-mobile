...
let datefinal=''+user_details.bankdetail.dob_year+'-'+user_details.bankdetail.dob_day+'-'+user_details.bankdetail.dob_month
                this.setState({
                    choosdate:datefinal,
                showdate:datefinal,
                firstname:user_details.bankdetail.first_name.toString(),
                lastname:user_details.bankdetail.last_name.toString(),
                email:user_details.bankdetail.email.toString(),
                bankname:user_details.bankdetail.bank_name.toString(),
                address1:user_details.bankdetail.address_line_1.toString(),
                address2:user_details.bankdetail.address_line_2.toString(),
                city:user_details.bankdetail.city.toString(),
                states:user_details.bankdetail.state.toString(),
                zipcode:user_details.bankdetail.zip_code.toString(),
                accountno:user_details.bankdetail.user_account.toString(),
                rounting:user_details.bankdetail.user_routing.toString(),
                mobile:user_details.bankdetail.mobile_num.toString(),
                    ...
                    <ScrollView >
                        <View style={{ backgroundColor: Colors.whiteColor, paddingBottom: windowHeight * 2 / 100 }}>
                            ...
                            <View style={CSSstyle.notification_header}>
                                ...
                                <Text style={[CSSstyle.Notifications_title, {}]}>{Lang_chg.editbank[config.language]}</Text>
                                <View >
                                    <Text >{'      '}</Text>
                                </View>
                            </View>
