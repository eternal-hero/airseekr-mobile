...
export default class Categorywise extends Component {
    ...
    componentDidMount() {
        this.props.navigation.addListener('focus', () => {
            ...
            this.setState({ loaddata: true, offset: 0, })
            //this.getvalue()
        });
        this.getvalue()
    }
    ...
    getfilterdata = () => {
        if (this.state.loaddata == true) {
            Keyboard.dismiss()
            let url = config.baseURL + 'get_filter_item.php'
            ...
            <View style={{ flex: 1, backgroundColor: Colors.whiteColor, }}>
                ...
                >
                    ...
                    <View style={CSSstyle.notification_header}>
                            ...
                            {!this.state.is_serach && <Text style={[CSSstyle.Notifications_title, {}]}>{this.state.category_name}</Text>}
                        ...
                        {/* <View style={CSSstyle.notification_header}>
                            ...
                            <Text style={[CSSstyle.Notifications_title, {}]}>{this.state.category_name}</Text>
                            {this.state.new_item != 'NA' ? <TouchableOpacity onPress={() => {  }} style={{ padding: 2, justifyContent: 'center' }} >
                                <Image style={[CSSstyle.icons, { resizeMode: "contain", }]} source={localimag.searchicon}></Image>
                            </TouchableOpacity> :
                                            ...
                                            <TouchableOpacity activeOpacity={0.7} onPress={() => { this.godetailpage(item,index)}} style={{ width: '46.2%', backgroundColor: Colors.whiteColor, elevation: 2, shadowColor: "#000", shadowOffset: { width: 2, height: 2, }, shadowOpacity: 0.20, alignItems: 'center', alignSelf: 'center', marginHorizontal: '2%', marginBottom: windowHeight * 1 / 100, marginTop: windowHeight * 1 / 100, borderRadius: 5, }}>
                                                ...
                                                <View style={{ flexDirection: 'row' }}>
                                                    ...
                                                    <View style={{ width: '30%', alignItems: 'flex-end' }}>
                                                        <TouchableOpacity style={{ paddingTop: windowHeight * .5 / 100,paddingHorizontal:windowHeight * 1.2 / 100 }}>
