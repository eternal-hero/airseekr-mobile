                        ...
                        {this.state.category_arr == "NA"  &&
                           ...
                           {this.state.category_arr != "NA" &&
                            ...
                            { this.state.category_arr.map((item, index) => (
                                 ...
                                 <TouchableOpacity style={{width: windowWidth * 26 / 100, height:windowHeight*16/100, alignItems:'center',borderColor:Colors.lightfontcolor,borderWidth:1,borderRadius:8,justifyContent:'center'}} onPress={() => {this.props.navigation.navigate('Categorywise',{category_id:item.category_id,category_name:item.category_name}) }}>
                                ...
                                // <View style={{width:windowWidth*30/100,  alignItems:'center',marginTop:windowHeight*3/100, }}>
                                //                 <TouchableOpacity onPress={()=>{this.props.navigation.navigate('Categorywise',{category_id:item.category_id,category_name:item.category_name[config.language]})}} style={{alignItems:'center'}}>
                                //                <View style={{width:windowWidth*19/100,height:windowWidth*19/100,borderRadius:windowWidth*9.5/100,backgroundColor:Colors.silver,alignItems:'center',justifyContent:'center'}}>
                                //                      <View style={{width:windowWidth*17/100,height:windowWidth*17/100,borderRadius:windowWidth*8.5/100,backgroundColor:Colors.theme_color2,alignItems:'center',justifyContent:'center'}}>
                                //                      <Image style={styles.icons} source={item.image}></Image>
                                //                      </View>
                                //                      </View>
                                //                      <Text numberOfLines={1} style={styles.txtitem3}>{item.name}</Text>
                                //                  </TouchableOpacity>
                                ...
                                //                <View style={{width:windowWidth*19/100,height:windowWidth*19/100,borderRadius:windowWidth*9.5/100,backgroundColor:Colors.silver,alignItems:'center',justifyContent:'center'}}>
                                //                     <View style={{width:windowWidth*17/100,height:windowWidth*17/100,borderRadius:windowWidth*8.5/100,backgroundColor:Colors.theme_color2,alignItems:'center',justifyContent:'center'}}>
                                //                     <Image style={styles.icons} source={{uri:config.img_url3+item.image}}></Image>
                                //                     </View>
                                //                     </View>
                                //                     <Text style={styles.txtitem3}>{item.category_name[config.language]}</Text>
                                //                 </TouchableOpacity>
...
const styles = StyleSheet.create({
    ...
    txtitem2: {
        fontSize: windowWidth * 2.8 / 100,marginTop:windowHeight*1/100, fontFamily: Font.Poppins_SemiBold, color: Colors.blackColor,paddingHorizontal:2
    },
