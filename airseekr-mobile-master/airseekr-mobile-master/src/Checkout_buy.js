...
export default class Checkout_buy extends Component {
    constructor(props) {
        super(props)
        this.state = {
            address: false,
    ...
    getcheckoutdata = () => {
        let url = config.baseURL + 'get_checkout_data.php?user_id=' + this.state.user_id+'&product_id='+this.state.product_id
