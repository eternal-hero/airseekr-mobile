...
export default class Editaddress extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            address_type: 2,
            user_id: '',
            address_data: this.props.route.params.addressdata,
            user_address_id: '',
            addmodal: false
    ...
    componentDidMount() {
        let address_data = this.state.address_data
        this.setState({
            add_type: address_data.address_type_name,
            setdefault: address_data.status_default,
    ...
    getvalue = async () => {
        ...
        if(config.newaddress !=''){
            this.setState({
                address: config.newaddress,
            })
        }
    }
    ...
    addresssubmit = () => {
        ...
        data.append("address_id", this.state.user_address_id)
            ...
            <View style={{ flex: 1, }}>
                ...
                <TouchableOpacity activeOpacity={0.9} onPress={() => { Keyboard.dismiss() }} style={{ flex: 1, backgroundColor: Colors.whiteColor, }}>
                    <View style={CSSstyle.notification_header}>
                        ...
                        <Text style={[CSSstyle.Notifications_title, {}]}>{Lang_chg.editaddress[config.language]}</Text>
                        <View >
                            <Text >{'      '}</Text>
                        </View>
                    </View>
